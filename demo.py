...
myobj = gTTS("Hi, I am Allin. What can I get you today?", lang='en', slow=False)
myobj.save('response.mp3')
os.system('mpg123 response.mp3')
...
while True:                
    ...
    if os.path.exists('current_speech.mp3'):
